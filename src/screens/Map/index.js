            ...
            <SafeAreaView style={{ flex: 1 }}>
                {loading ? (
                    ...
                    <View>
                        ...
                        <TouchableOpacity style={styles.btn_leftMenu} onPress={() => this.props.navigation.goBack()}>
                            <Icon name="arrow-left" size={20} style={styles.icon_leftMenu} />
                        </TouchableOpacity>
...
const mapStyle = [
    ...
    //   ],
    // },
    // metro, otobüs duraklar gözüküyor
    {
        featureType: 'poi',
        stylers: [
            {
